...
public class ColorArcProgressBar extends View {
    ...
    private float curSpeedSize = dipToPx(20); //title size
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        TypedArray a =  context.getTheme().obtainStyledAttributes(attrs,R.styleable.ColorArcProgressBar,0,0);

        int color1 = a.getColor(R.styleable.ColorArcProgressBar_front_color1,0xFF000000);
        int color2 = a.getColor(R.styleable.ColorArcProgressBar_front_color2,0xFF000000);
        int color3 = a.getColor(R.styleable.ColorArcProgressBar_front_color3,0xFF000000);
        ...
        isNeedBackground = a.getBoolean(R.styleable.ColorArcProgressBar_is_need_background, true);
...
//当前进度
    ...
    public void setIsNeedBackground(boolean isNeedBackground){this.isNeedBackground = isNeedBackground;}
