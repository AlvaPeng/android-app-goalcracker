...
public class SwipeMenuAdapter implements WrapperListAdapter,SwipeMenuView.OnSwipeItemClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mAdapter instanceof BaseSwipeListAdapter) {
            boolean swipEnable = (((BaseSwipeListAdapter) mAdapter).getSwipEnableByPosition(position));
    ...
    public void createMenu(SwipeMenu menu) {
        ...
        item.setGoalName("READING");
        item.setItemIcon(mContext.getResources().getDrawable(R.drawable.default_pic));

        menu.addMenuItem(item);

        item = new GoalItem();
        item.setGoalName("CODING");
        item.setItemIcon(mContext.getResources().getDrawable(R.drawable.default_pic));
        menu.addMenuItem(item);
    }
