...
public class MapTest extends BaseActivity implements SensorEventListener, View.OnClickListener {
    /**
     * 规定到达距离范围距离
     */
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //打卡范围
            mDestinationPoint = new LatLng(39.920564, 116.564168);//图书馆坐标
            setCircleOptions();
            //计算两点距离,单位：米
            mDistance = DistanceUtil.getDistance(mDestinationPoint, LocationPoint);
            if (mDistance <= DISTANCE) {
                //显示文字
                setTextOption(mDestinationPoint, "您已在目标范围内", "#7ED321");
                //目的地图标
                ...
                setTextOption(LocationPoint, "您不在目标范围内", "#FF6C6C");
